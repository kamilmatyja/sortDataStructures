...
internal class Program
{
    ...
    static private void Results(string type = "random")
    {
        for (int i = 1; i <= 100; i++)
        {
            ...
            Console.WriteLine("{0};{1};{2};{3};{4};{5};{6};", i, type, ts1.TotalMilliseconds, ts2.TotalMilliseconds, ts3.TotalMilliseconds, ts4.TotalMilliseconds, ts5.TotalMilliseconds, ts6.TotalMilliseconds);
        }
    }
}